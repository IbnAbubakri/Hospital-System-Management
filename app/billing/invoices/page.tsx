...
import { Space, Drawer, Descriptions, Modal, Form, Input, Select, Alert, Divider, Tag, Typography } from 'antd';
...
export default function InvoicesPage() {
  ...
  const stats = {
    ...
    collectedAmount: mockInvoices.reduce((sum, inv) => sum + inv.paidAmount, 0),
  };
